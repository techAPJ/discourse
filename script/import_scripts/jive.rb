...
class ImportScripts::Jive < ImportScripts::Base
  ...
  BATCH_SIZE = 1000
  CATEGORY_IDS = [2023,2003,2004,2042,2036,2029]
  ...
  def normalize_raw!(raw)
    ...
    # <span __jive_emoticon_name="happy"></span>

    # s.gsub!(/<span __jive_emoticon_name="happy">(.*?)<\/span>/m, '[ul]\1[/ul]')
    # s.gsub!(/<span __jive_emoticon_name="wink">(.*?)<\/span>/m, '[ul]\1[/ul]')

    # <img __jive_ID="1022" __jive_id="1022" alt="archive-disclosure11.png" class="jive-image" src="archive-disclosure11.png"/>
    ...
    doc.css('span').each do |span|
      # if span['__jive_emoticon_name'] == "happy"
      #   puts span['__jive_emoticon_name']
      #   exit
      # end
      # span.replace = " :smile: " if span['__jive_emoticon_name'] == 'happy' or span['__jive_emoticon_name'] == '"happy"'
      # span.replace " :wink: " if span['__jive_emoticon_name'] == 'wink' or span['__jive_emoticon_name'] == '"wink"'
      span.replace " :#{span['__jive_emoticon_name']}: " if span['__jive_emoticon_name'].present?
    end
  ...
  # def get_topic_id_from_thread_id(thread_id)
  #   return
  # end
...
# <span __jive_emoticon_name="happy"></span>
# <span __jive_emoticon_name="wink" __jive_macro_name="emoticon" class="jive_macro jive_emote" src="/4.5.5/images/emoticons/wink.gif"></span>
# Carla.kochalski@capitalone.com&lt;mailto:Carla.kochalski@capitalone.com&gt;.
# <img __jive_ID="1022" __jive_id="1022" alt="archive-disclosure11.png" class="jive-image" src="archive-disclosure11.png"/>
