    ...
    batches(BATCH_SIZE) do |offset|
      ...
      create_posts(private_messages, total: topic_count, offset: offset) do |m|
        ...
        if title =~ /^Re:/
          ...
          parent_id = title_username_of_pm_first_post[[title[9..-1], participants]] unless parent_id
          parent_id = title_username_of_pm_first_post[[title[10..-1], participants]] unless parent_id
          parent_id = title_username_of_pm_first_post[[title[11..-1], participants]] unless parent_id
          parent_id = title_username_of_pm_first_post[[title[12..-1], participants]] unless parent_id
          if parent_id
